...
export namespace SdkMetric {
    ...
    enum Type {
        ...
        AUDIO_SENT_TRANSFORM_PPS = 109,
        AUDIO_RECEIVED_TRANSFORM_PPS = 110,
        VIDEO_SENT_TRANSFORM_PPS = 111,
        VIDEO_RECEIVED_TRANSFORM_PPS = 112,
        ...
        VIDEO_RECEIVED_RETRANSMIT_BITRATE = 129
    }
}
