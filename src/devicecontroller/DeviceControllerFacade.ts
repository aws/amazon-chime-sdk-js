...
export default interface DeviceControllerFacade {
  ...
  /**
   * Stop the current audio input. This needs to be called to stop the current audio input resources
  ...
  /**
   * Stop the current video input. This needs to be called to stop the current video input resources
