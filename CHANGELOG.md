...
- Add support for clients to send manual transcriptions to all other clients. Also allows clients to correct transcript results received from live transcription and send the update to other clients.
