...
function findAllElements() {
  ...
  elements = {
    ...
    videoFxBackgroundBlurFilterButton: By.id('dropdown-menu-filter-Video-Fx---Background-Blur-High'),
    backgroundReplacementFilterButton: By.id('dropdown-menu-filter-Background-Replacement'),
    videoFxBackgroundReplacementFilterButton: By.id('dropdown-menu-filter-Video-Fx---Background-Replacement-(Blue)'),
